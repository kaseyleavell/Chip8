...
class chip8
{
	public:
		...
		*/
		...
		//-----------------------------------------------------------------------------------------------------------------------
		int LoadGame(std::string gameName) {
				...
				case 0x0000:
					...
					* NOTE: This is the address of the jump instruction. This is incremented as it is pushed onto the stack. DO NOT increment it after it is popped off the stack
					...
					case 0x00EE:
						...
						//-------------------------------------------------------
					default:
						std::cout << "ERROR: There is an error with the current value of UNSIGNED SHORT opCode. This code cannot be processed." << std::endl;
