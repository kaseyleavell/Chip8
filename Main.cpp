...
#define TEST_FLAG 1 //This defines whether the program will be running benchmarks on the program as it runs
...
int main(int argc, char** argv)
{
    ...
    if (testFlag) {
        ...
        std::cout << "The program ran " << cycles << " cycles in " << std::chrono::duration_cast<std::chrono::microseconds>(end-start).count() << " Microseconds" << endl;
    }
    else {
        // Emulation loop
        for (;;)
